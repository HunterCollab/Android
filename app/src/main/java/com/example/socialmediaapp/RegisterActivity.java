...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //MyLoopjTask myLoopTask = new MyLoopjTask(this, (MyLoopjTask.OnLoopComplete) this); //Not required??
        ...
        RegisterButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                httpClient.get(Tools.BASE_API_URL + "/user/createUser", params, new JsonHttpResponseHandler() {
                    @Override
                    public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                        try {
                            if (response.has("success") && response.getBoolean("success")) { //Success variable is true.
                                System.out.println(response.toString());
                                // Tell user account was successfully created
                                // Send user to login page so they can login with the account they just created.
                            } else {
